...
const MyItemsPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      {showForm && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          <form onSubmit={handleAddItem} className="space-y-4">
            <h2 className="text-xl font-semibold">New Item Details</h2>
            ...
            <div className="flex justify-end">
              <Button type="submit" isLoading={isSubmitting}>Submit Item</Button>
            </div>
          </form>
        </div>
      )}
      ...
      {items.length === 0 ? (
        <p className="text-center text-gray-500 dark:text-gray-400">You haven't added any items yet.</p>
      ) : (
