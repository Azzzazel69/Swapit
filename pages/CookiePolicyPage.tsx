...
const CookiePolicyPage = () => {
    ...
    return (
        React.createElement("div", { className: "max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md" },
            ...
            React.createElement(PolicySection, { title: "¿Qué son las cookies?" },
            ...
            React.createElement(PolicySection, { title: "¿Cómo utilizamos las cookies?" },
            ...
            React.createElement(PolicySection, { title: "Sus Opciones" },
            ...
            React.createElement(PolicySection, { title: "Cambios en esta Política" },
