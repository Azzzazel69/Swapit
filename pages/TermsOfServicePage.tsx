...
const TermsOfServicePage = () => {
    // FIX: Changed component signature from ({ title, children }) to (props) to fix type error with React.createElement
    ...
    return (
        React.createElement("div", { className: "max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md" },
            ...
            React.createElement(LegalSection, { title: "1. Aceptación de los Términos" },
            ...
            React.createElement(LegalSection, { title: "2. Descripción del Servicio" },
            ...
            React.createElement(LegalSection, { title: "3. Cuentas de Usuario" },
            ...
            React.createElement(LegalSection, { title: "4. Contenido del Usuario" },
            ...
            React.createElement(LegalSection, { title: "5. Limitación de Responsabilidad" },
            ...
            React.createElement(LegalSection, { title: "6. Modificaciones a los Términos" },
